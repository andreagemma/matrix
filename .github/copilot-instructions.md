# Copilot Instructions for matrix

## Project Description

matrix is a typed Python package for matrix and OD/ODT tabular operations used in transportation and analytics workflows.
...
- This is a Python package with sources under `src/matrix`.
